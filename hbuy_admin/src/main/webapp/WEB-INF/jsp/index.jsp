	...
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-right">
			...
			<li class="layui-nav-item">
				<span class="hp-kd" style="color: red">djin</span>
			</li>
			<li class="layui-nav-item">
	...
	<div class="layui-side hp-left-menu">
		<div class="layui-side-scroll">
			...
			<ul class="layui-nav layui-nav-tree" lay-filter="test">
				...
				<li class="layui-nav-item">
					<a href="javascript:;"><i class="layui-icon">&#xe62a;</i>导航管理</a>
					<dl class="layui-nav-child" style="padding-left: 15px">
						<dd>
							<a class="hp-tab-add" hp-href="model/toWebMenu" href="javascript:;" >导航查询</a>
						</dd>
					</dl>
				</li>
			</ul>
