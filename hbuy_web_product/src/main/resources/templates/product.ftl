...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl" id="loginHeader">你好，请<a href="http://localhost:8091/" target="blank" id="titleUser">登录</a>&nbsp; <a href="localhost:8084/webusers/toReg" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="fl">&nbsp;<a href="javascript:void(0)" id="exitUser" style="color: red" >注销&nbsp;</a></span>
            <span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="i_car">
    	<div class="car_t">购物车 [ <span id="goodsNum">0</span> ]</div>
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
...
<div class="i_bg">
    ...
    <div class="content">
        <input type="hidden" id="goodIdInput" value="${id}"/>
        <div id="tsShopContainer">
            ...
            <div id="tsPicContainer">
                ...
                <div id="tsImgSCon">
                    <ul>
                        <#list productImgs as temp>
                            <li onclick="showPic(${temp_index})" rel="MagicZoom">
                                <img src="${temp.imgurl}" tsImgS="${temp.imgurl}" width="79" height="79" />
                            </li>
                        </#list>
                    </ul>
                </div>
...
<script type="text/javascript">
    //此时的freemarker语法中使用了$符号，此时的jquery对象就不再此处文件中再使用$表示jquery对象
    //此处文件中的jquery对象直接用jQuery来表示
    jQuery(function () {
        ...
        jQuery("#discuss").click(function () {
            jQuery.ajax({
                type:'POST',
                url:'http://localhost:8068/discuss/loadPageDiscuss',
                dataType:'JSON',
                data:{'page':1,"limit":5},
                success:function (rs) {
                    console.log(rs);
        ...
        jQuery("#addBuyCarBtn").click(function () {
            ...
            var goodIdInput = jQuery("#goodIdInput").val();
            var goodId = goodIdInput.replace(",","");
            console.log("goodId = "+goodId);
            console.log("num = "+jQuery("#goodNum").val());
            jQuery.ajax({
                type:'post',
                url:'http://localhost:8086/buyCar/addBuyCar',
                xhrFields:{withCredentials:true},  //允许ajax的跨域访问
                data:{"goodId":goodId,"num":jQuery("#goodNum").val(),"token":token},
        ...
        /*登录后合并购物车*/
        function loginToAppendBuyCar(uid){
            jQuery.ajax({
                type:'post',
                url:'http://localhost:8086/buyCar/loginToAppendBuyCar',
            ...
            jQuery.ajax({
                ...
                success:function (rs) {
                    ...
                    if (rs != ''){
                        ...
                        InterValObj = window.setInterval(getToken, 3000);  //登录失败, 重启js轮循
                    }
                },
                error:function (rs) {
                    alert("服务器异常");
        ...
        jQuery("#exitUser").click(function () {
            jQuery.ajax({
                ...
                success:function (data) {
                    ...
                    if(data){
                        token = null;  //将令牌为null
                        jQuery("#goodsNum").text(0);
                        jQuery("#showBuyCarUl").html("")
                        jQuery("#zprice").text(0.0);
                        jQuery("#buyCarDiv").html('还未登录！<a href="Login.html" style="color:#ff4e00;">马上登录</a> 查看购物车！');
